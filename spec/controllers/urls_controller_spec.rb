...
describe UrlsController do
  ...
  let(:valid_attributes) { { "report_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved url as @url" do
        ...
        post :create, {:url => { "report_id" => "invalid value" }}, valid_session
        assigns(:url).should be_a_new(Url)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested url" do
        ...
        Url.any_instance.should_receive(:update).with({ "report_id" => "1" })
        put :update, {:id => url.to_param, :url => { "report_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the url as @url" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Url.any_instance.stub(:save).and_return(false)
        put :update, {:id => url.to_param, :url => { "report_id" => "invalid value" }}, valid_session
        assigns(:url).should eq(url)
      end
